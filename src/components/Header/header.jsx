...
const navigation = [
  { name: `Today's Deal`, href: '/dashboard', current: false },
  { name: 'Customer Service', href: '#customer-service', current: false },
  { name: 'Registry', href: '/auth/register', current: false },
  { name: 'Sell', href: '/auth', current: false },
];
...
function Header({ logout, cart, user }) {
